...
public class UploadFileController {
	...
	public String uploadImage(@RequestParam(value="dir", required=false, defaultValue="/")String dir,
...
//		String dir = imageService.getDirectoryName(fileId);
		service.updateDirectory(fileIds, directoryName);
		return "redirect:/upload/list";
	}
}
