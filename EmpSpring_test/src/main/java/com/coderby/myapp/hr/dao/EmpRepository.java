	...
	JdbcTemplate jdbcTemplate;
	  ...
	  public class EmpMapper implements RowMapper<EmpVO> {
		...
		public String getEmail(int empId) {
			...
			String sql = "select email from emp1 where employee_id =?";
		  ...
		  public void insertEmp(EmpVO emp) {
		    String sql = "insert into emp1 (employee_id, first_name, "
		  ...
		  public List<Map<String, Object>> getAllManagerId() {
		    String sql = "select "
		          ...
		          + "from departments d join emp1 e "
